        ...
        <div className="min-h-dvh flex">
            ...
            <div className="w-full justify-center md:w-1/2 flex flex-col gap-11 items-center p-6">
                ...
                <form
                    ...
                    className="w-[85%] lg:w-3/4 flex flex-col items-center gap-7"
                >
                    {/* Name */}
                    ...
                    {/* Submit */}
                    <Button
                        className="w-full mt-5 text-md py-5 font-semibold"
                        variant={"secondary"}
                        type="submit"
                        disabled={processing}
                    >
                ...
                <p>Already have an account? <Link className="text-[#4F4FF9] underline" href={route('login')}>Sign in</Link></p>
            </div>
