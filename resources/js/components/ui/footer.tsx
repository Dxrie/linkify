...
imimport { Link } from "@inertiajs/react";
...
=======
        <footer className="flex flex-col w-full bg-background text-foreground p-15 divide-y-2 gap-3 relative z-50">
...
>>>>>>> f69774ecd54b9daa3a0070c542aba0567bc09724
...
}port { Github, Linkedin, Mail } from "lucide-react";
